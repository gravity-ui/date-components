...
describe('RangeDateField: form', () => {
    it('should submit empty value by default', async () => {
        ...
        render(
            <form data-qa="form" onSubmit={onSubmit}>
                <RangeDateField name="date-field" />
    ...
    it('should submit default value', async () => {
        ...
        render(
            <form data-qa="form" onSubmit={onSubmit}>
                <RangeDateField name="date-field" defaultValue={range} />
                <button type="submit" data-qa="submit">
                    submit
                </button>
            </form>,
    ...
    it('should submit controlled value', async () => {
        ...
        render(
            <form data-qa="form" onSubmit={onSubmit}>
                <RangeDateField name="date-field" value={range} />
                <button type="submit" data-qa="submit">
                    submit
                </button>
            </form>,
    ...
    it('supports form reset', async () => {
        function Test() {
            ...
            return (
                <form>
                    <RangeDateField name="date-field" value={value} onUpdate={setValue} />
